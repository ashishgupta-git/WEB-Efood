 ...
 font-weight:bolder;
  ...
  <body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark fixed-top">
     ...
     <a href="practical/signup.php"><button id="signup">Sign Up</button></a>
     <a href=""><button id="signup">Log In</button></a>
  </nav>
    ...
    <footer>
        <div class="footer-content">
          ...
          <div class="footer-section">
            ...
            <a href="practical/feedback.php"> <button class="feedback">Your Feedback</button></a>
          </div>
          <div class="footer-section">
